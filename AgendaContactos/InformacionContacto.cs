...
namespace AgendaContactos
{
    public partial class InformacionContacto : Form
    {
        ...
        bool ValidarNombreUnico(string nombre) //confirmara que no exista otra persona igual en la lista de contactos
        {
            var json = new Json();
        ...
        private void bttnActualizar_Click(object sender, EventArgs e)
        {
            ...
            if (!ValidarNombreUnico(txtBoxNombre.Text)) // En caso de que se escriba una persona ya colocada anteriormente, mandara mensaje de alerta
            {
